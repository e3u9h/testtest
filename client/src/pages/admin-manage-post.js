...
import './admin-manage-post.css'

const AdminManagePost = (props) => {
  return (
    <div className="admin-manage-post-container">
      <Helmet>
        <title>AdminManagePost - Downright Previous Termite</title>
        <meta
          property="og:title"
          content="AdminManagePost - Downright Previous Termite"
        />
      </Helmet>
      <div className="admin-manage-post-hero">
        <div className="admin-manage-post-sidebar">
          <img
            alt="image"
            src="/external/wechatimg148-200h.jpg"
            className="admin-manage-post-image"
          />
          <nav className="admin-manage-post-nav">
            <div className="admin-manage-post-container01">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="admin-manage-post-icon"
              >
              ...
              <span className="admin-manage-post-text">Home</span>
            </div>
            <div className="admin-manage-post-container02">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="admin-manage-post-icon02"
              >
              ...
              <span className="admin-manage-post-text01">Search</span>
            </div>
            <div className="admin-manage-post-container03"></div>
            <div className="admin-manage-post-container04">
              <svg viewBox="0 0 1024 1024" className="admin-manage-post-icon04">
              ...
              <span className="admin-manage-post-text02">Notifications</span>
            </div>
            <div className="admin-manage-post-container05">
              <svg viewBox="0 0 1024 1024" className="admin-manage-post-icon06">
              ...
              <span className="admin-manage-post-text03">Messages</span>
            </div>
            <div className="admin-manage-post-container06">
              <svg
                viewBox="0 0 731.4285714285713 1024"
                className="admin-manage-post-icon08"
              >
              ...
              <span className="admin-manage-post-text04">Profile</span>
            </div>
            <div className="admin-manage-post-container07">
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="admin-manage-post-icon10"
              >
              ...
              <span className="admin-manage-post-text05">Settings</span>
            </div>
            <div className="admin-manage-post-container08"></div>
            <button
              type="button"
              className="admin-manage-post-button mybutton button"
            >
              Post
            </button>
          </nav>
          <div className="admin-manage-post-profile">
            <div
              data-thq="thq-dropdown"
              className="admin-manage-post-thq-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="admin-manage-post-dropdown-toggle"
              >
                <img
                  alt="image"
                  src="https://play.teleporthq.io/static/svg/default-img.svg"
                  className="admin-manage-post-image1"
                />
                <div className="admin-manage-post-container09">
                  <span className="admin-manage-post-text06">
                    <span>Admin</span>
                    <br></br>
                  </span>
                  <span className="admin-manage-post-text09">id: 000</span>
                </div>
                <div
                  data-thq="thq-dropdown-arrow"
                  className="admin-manage-post-dropdown-arrow"
                ></div>
              </div>
              <ul
                data-thq="thq-dropdown-list"
                className="admin-manage-post-dropdown-list"
              >
                <li
                  data-thq="thq-dropdown"
                  className="admin-manage-post-dropdown list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="admin-manage-post-dropdown-toggle1"
                  >
                    <span className="admin-manage-post-text10">Logout</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                  className="admin-manage-post-dropdown1 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="admin-manage-post-dropdown-toggle2"
                  >
                    <span className="admin-manage-post-text11">
                      Reset Password
                    </span>
                  </div>
                </li>
        ...
        <div className="admin-manage-post-container10">
          <div className="admin-manage-post-container11">
            <Link to="/profile" className="admin-manage-post-navlink">
              <svg
                viewBox="0 0 1024 1024"
                className="admin-manage-post-icon12 button"
              >
            ...
            <h1 className="admin-manage-post-text12">
              <span className="admin-manage-post-text13">Manage Posts</span>
              <br></br>
            </h1>
          </div>
          <div className="admin-manage-post-container12">
            <input
              type="text"
              placeholder="Search Post"
              className="admin-manage-post-textinput input"
            />
          </div>
          <div className="admin-manage-post-container13">
            <ManagePost
              postID1="Post ID: 001"
              blockDate="28/02/2024"
              rootClassName="manage-post-root-class-name"
            ...
            <ManagePost
              ...
              postID1="Post ID: 002"
              blockDate="28/02/2024"
              rootClassName="manage-post-root-class-name1"
              followStatusbutton21="View"
            ></ManagePost>
            <ManagePost
              postID="003"
              postID1="Post ID: 003"
              blockDate="28/02/2024"
              rootClassName="manage-post-root-class-name2"
              followStatusbutton21="View"
            ></ManagePost>
            <ManagePost
              postID="004"
              postID1="Post ID: 004"
              blockDate="02/03/2024"
              rootClassName="manage-post-root-class-name3"
              followStatusbutton21="View"
            ></ManagePost>
            <ManagePost
              postID="005"
              postID1="Post ID: 005"
              rootClassName="manage-post-root-class-name4"
              followStatusbutton21="View"
            ></ManagePost>
          </div>
        </div>
