...
const Createpost = (props) => {
  return (
    <div className="createpost-container">
      <Helmet>
        <title>createpost - Downright Previous Termite</title>
        <meta
          property="og:title"
          content="createpost - Downright Previous Termite"
        />
      </Helmet>
      <div className="createpost-container01">
        <div className="createpost-container02">
          <Link to="/search" className="createpost-navlink button">
            Search
          </Link>
          <img
            alt="image"
      ...
      <div className="createpost-hero">
        <div className="createpost-sidebar">
          <nav className="createpost-nav">
            <div className="createpost-container03">
              <svg
              ...
              <Link to="/" className="createpost-navlink1">
                Home
              </Link>
            </div>
            <div className="createpost-container04">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="createpost-icon02"
              >
              ...
              <span className="createpost-text">
                <span>Search</span>
                <br></br>
              </span>
            </div>
            <div className="createpost-container05"></div>
            <div className="createpost-container06">
              <svg viewBox="0 0 1024 1024" className="createpost-icon04">
              ...
              <span className="createpost-text03">Notifications</span>
            </div>
            <div className="createpost-container07">
              <svg viewBox="0 0 1024 1024" className="createpost-icon06">
              ...
              <span className="createpost-text04">Messages</span>
            </div>
            <div className="createpost-container08">
              <svg
                viewBox="0 0 731.4285714285713 1024"
                className="createpost-icon08"
              >
              ...
              <Link to="/profile" className="createpost-navlink2">
                Profile
              </Link>
            </div>
            <div className="createpost-container09">
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="createpost-icon10"
              >
              ...
              <span className="createpost-text05">Settings</span>
            </div>
            <div className="createpost-container10"></div>
            <button type="button" className="createpost-button mybutton button">
              Post
            </button>
          </nav>
          <div className="createpost-profile">
            <div
              ...
              className="createpost-thq-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="createpost-dropdown-toggle"
              >
                <img
                  alt="image"
                  src="/external/%C3%A5%C2%BE%C2%AE%C3%A4%C2%BF%C2%A1%C3%A5%C2%9B%C2%BE%C3%A7%C2%89%C2%87_20240323020804-200h.jpg"
                  className="createpost-image1"
                />
                <div className="createpost-container11">
                  <span className="createpost-text06">GroupA1 Student</span>
                  <span className="createpost-text07">id: 001</span>
                </div>
                <div
                  data-thq="thq-dropdown-arrow"
                  className="createpost-dropdown-arrow"
                ></div>
              </div>
              <ul
                data-thq="thq-dropdown-list"
                className="createpost-dropdown-list"
              >
                <li
                  data-thq="thq-dropdown"
                  className="createpost-dropdown list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="createpost-dropdown-toggle1"
                  >
                    <span className="createpost-text08">Logout</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                  className="createpost-dropdown1 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="createpost-dropdown-toggle2"
                  >
                    <span className="createpost-text09">Reset Password</span>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div className="createpost-hero1 heroContainer">
          <h1 className="createpost-text10">
            <span>Hi, GroupA1Student!</span>
            <br></br>
            <span>DId anything interesting happen?</span>
            <br></br>
          </h1>
          <div className="createpost-container12">
            <textarea
              placeholder="edit your post"
              className="createpost-textarea textarea"
            ></textarea>
            <div className="createpost-container13">
              <svg viewBox="0 0 1024 1024" className="createpost-icon12">
              ...
              <svg viewBox="0 0 1024 1024" className="createpost-icon16">
              ...
              <button
                type="button"
                className="createpost-button1 mybutton button"
              >
                Post
              </button>
            </div>
        ...
        <RightSidebar rootClassName="right-sidebar-root-class-name4"></RightSidebar>
      </div>
      <div className="createpost-features"></div>
      <div className="createpost-banner"></div>
      <div className="createpost-banner1"></div>
      <div className="createpost-faq"></div>
      <div className="createpost-pricing"></div>
      <Footer rootClassName="footer-root-class-name8"></Footer>
      <div className="createpost-footer"></div>
      <div className="createpost-faq-container faqContainer"></div>
    </div>
  )
}
