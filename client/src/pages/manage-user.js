...
import ManageUserComponent from '../components/manage-user'
...
const ManageUser = (props) => {
  return (
    <div className="manage-user-container">
      <Helmet>
        <title>ManageUser - Downright Previous Termite</title>
        <meta
          property="og:title"
          content="ManageUser - Downright Previous Termite"
        />
      </Helmet>
      <div className="manage-user-container01">
        <img
          alt="image"
          src="/external/wechatimg148-200h.jpg"
          className="manage-user-image"
        />
        <div className="manage-user-sidebar">
          <nav className="manage-user-nav">
            <div className="manage-user-container02">
              <svg
              ...
              <span className="manage-user-text">Home</span>
            </div>
            <div className="manage-user-container03">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="manage-user-icon02"
              >
              ...
              <span className="manage-user-text01">Search</span>
            </div>
            <div className="manage-user-container04"></div>
            <div className="manage-user-container05">
              <svg viewBox="0 0 1024 1024" className="manage-user-icon04">
              ...
              <span className="manage-user-text02">Notifications</span>
            </div>
            <div className="manage-user-container06">
              <svg viewBox="0 0 1024 1024" className="manage-user-icon06">
              ...
              <span className="manage-user-text03">Messages</span>
            </div>
            <div className="manage-user-container07">
              <svg
                viewBox="0 0 731.4285714285713 1024"
                className="manage-user-icon08"
              >
              ...
              <span className="manage-user-text04">Profile</span>
            </div>
            <div className="manage-user-container08">
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="manage-user-icon10"
              >
              ...
              <span className="manage-user-text05">Settings</span>
            </div>
            <div className="manage-user-container09"></div>
            <button
              type="button"
              className="manage-user-button mybutton button"
            >
              Post
            </button>
          </nav>
          <div className="manage-user-profile">
            <div
              ...
              className="manage-user-thq-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="manage-user-dropdown-toggle"
              >
                <img
                  alt="image"
                  src="https://play.teleporthq.io/static/svg/default-img.svg"
                  className="manage-user-image1"
                />
                <div className="manage-user-container10">
                  <span className="manage-user-text06">
                    <span>Admin</span>
                    <br></br>
                  </span>
                  <span className="manage-user-text09">id: 000</span>
                </div>
                <div
                  data-thq="thq-dropdown-arrow"
                  className="manage-user-dropdown-arrow"
                ></div>
              </div>
              <ul
                data-thq="thq-dropdown-list"
                className="manage-user-dropdown-list"
              >
                <li
                  data-thq="thq-dropdown"
                  className="manage-user-dropdown list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="manage-user-dropdown-toggle1"
                  >
                    <span className="manage-user-text10">Logout</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                  className="manage-user-dropdown1 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="manage-user-dropdown-toggle2"
                  >
                    <span className="manage-user-text11">Reset Password</span>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <div className="manage-user-container11">
        <div className="manage-user-container12">
          <Link to="/profile" className="manage-user-navlink">
            <svg viewBox="0 0 1024 1024" className="manage-user-icon12 button">
          ...
          <h1 className="manage-user-text12">
            <span className="manage-user-text13">Manage Users</span>
            <br></br>
          </h1>
        </div>
        <div className="manage-user-container13">
          <input
            type="text"
            placeholder="Search User"
            className="manage-user-textinput input"
          />
        </div>
        <div className="manage-user-container14">
          <ManageUserComponent
            iD="001"
            name="GroupA1 Student"
            blockDate="1/1/2024"
            rootClassName="manage-user-root-class-name4"
            followStatusbutton="Suspend"
            followStatusbutton1="Delete"
            followStatusbutton2="View"
          ></ManageUserComponent>
          <ManageUserComponent
            iD="002"
            blockDate="1/1/2024"
            rootClassName="manage-user-root-class-name5"
            followStatusbutton="Suspend"
            followStatusbutton1="Delete"
            followStatusbutton2="View"
          ></ManageUserComponent>
          <ManageUserComponent
            ...
            name="Michael"
            blockDate="1/1/2024"
            rootClassName="manage-user-root-class-name6"
            followStatusbutton="Suspend"
            followStatusbutton1="Delete"
            followStatusbutton2="View"
          ></ManageUserComponent>
          <ManageUserComponent
            ...
            name="Love3100"
            blockDate="1/1/2024"
            rootClassName="manage-user-root-class-name7"
            followStatusbutton="Suspend"
            followStatusbutton1="Delete"
            followStatusbutton2="View"
          ></ManageUserComponent>
          <ManageUserComponent
            ...
            name="TeacherHa"
            blockDate="1/1/2024"
            rootClassName="manage-user-root-class-name8"
            followStatusbutton="Suspend"
            followStatusbutton1="Delete"
            followStatusbutton2="View"
          ></ManageUserComponent>
          <ManageUserComponent
            ...
            name="3100BigFan"
            blockDate="1/1/2024"
            rootClassName="manage-user-root-class-name9"
            followStatusbutton="Suspend"
            followStatusbutton1="Delete"
            followStatusbutton2="View"
          ></ManageUserComponent>
      ...
      <button
        name="AddUser"
        type="button"
        className="manage-user-button1 button"
      >
        <Link to="/register11" className="manage-user-navlink1">
          <span>Add User</span>
          <br></br>
        </Link>
      </button>
