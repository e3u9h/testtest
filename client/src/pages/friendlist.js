...
const Friendlist = (props) => {
  return (
    <div className="friendlist-container">
      <Helmet>
        <title>Friendlist - Downright Previous Termite</title>
        <meta
          property="og:title"
          content="Friendlist - Downright Previous Termite"
        />
      </Helmet>
      <div className="friendlist-container01">
        <div className="friendlist-sidebar">
          <nav className="friendlist-nav">
            <div className="friendlist-container02">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="friendlist-icon"
              >
              ...
              <Link to="/" className="friendlist-navlink">
                Home
              </Link>
            </div>
            <div className="friendlist-container03">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="friendlist-icon02"
              >
              ...
              <Link to="/search" className="friendlist-navlink1">
                Search
              </Link>
            </div>
            <div className="friendlist-container04"></div>
            <div className="friendlist-container05">
              <svg viewBox="0 0 1024 1024" className="friendlist-icon04">
              ...
              <span className="friendlist-text">Notifications</span>
            </div>
            <div className="friendlist-container06">
              <svg viewBox="0 0 1024 1024" className="friendlist-icon06">
              ...
              <span className="friendlist-text01">Messages</span>
            </div>
            <div className="friendlist-container07">
              <svg
                viewBox="0 0 731.4285714285713 1024"
                className="friendlist-icon08"
              >
              ...
              <Link to="/profile" className="friendlist-navlink2">
                Profile
              </Link>
            </div>
            <div className="friendlist-container08">
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="friendlist-icon10"
              >
              ...
              <span className="friendlist-text02">Settings</span>
            </div>
            <div className="friendlist-container09"></div>
            <button type="button" className="friendlist-button mybutton button">
              Post
            </button>
          </nav>
          <div className="friendlist-profile">
            <div
              ...
              className="friendlist-thq-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="friendlist-dropdown-toggle"
              >
                <img
                  alt="image"
                ...
                />
                <div className="friendlist-container10">
                  <span className="friendlist-text03">GroupA1 Student</span>
                  <span className="friendlist-text04">id: 001</span>
                </div>
                <div
                  data-thq="thq-dropdown-arrow"
                  className="friendlist-dropdown-arrow"
                ></div>
              </div>
              <ul
                data-thq="thq-dropdown-list"
                className="friendlist-dropdown-list"
              >
                <li
                  data-thq="thq-dropdown"
                  className="friendlist-dropdown list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="friendlist-dropdown-toggle1"
                  >
                    <span className="friendlist-text05">Logout</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                  className="friendlist-dropdown1 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="friendlist-dropdown-toggle2"
                  >
                    <span className="friendlist-text06">Reset Password</span>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <img
          ...
          className="friendlist-image1"
        />
      </div>
      <div className="friendlist-container11">
        <div className="friendlist-container12">
          <Link to="/profile" className="friendlist-navlink3">
            <svg viewBox="0 0 1024 1024" className="friendlist-icon12">
          ...
          <h1 className="friendlist-text07">
            <span className="friendlist-text08">GroupA1 Student</span>
            <br className="friendlist-text09"></br>
            <span className="friendlist-text10">id: 001</span>
            <br></br>
          </h1>
        </div>
        <div className="friendlist-container13">
          <div className="friendlist-container14">
            <button type="button" className="friendlist-button1 button">
              Blacklist
            </button>
          </div>
          <div className="friendlist-container15">
            <Link to="/follower-page" className="friendlist-navlink4 button">
              Followers
            </Link>
          </div>
          <div className="friendlist-container16">
            <button type="button" className="friendlist-button2 button">
              Following
            </button>
          </div>
        </div>
        <div className="friendlist-container17">
          <Following
            iD="004"
            name="Love3100"
            intro="CGPA 3.979"
            imageSrc="/97e4cf398c1c453f98f8135b202479d6-200h.jpg"
            rootClassName="following-root-class-name3"
          ></Following>
          <Following
            iD="003"
            name="Michael"
            ...
            rootClassName="following-root-class-name2"
          ></Following>
          <Following
            iD="005"
            name="TeacherHa"
            ...
            rootClassName="following-root-class-name4"
          ></Following>
          <Following
            iD="006"
            name="3100BigFan"
            ...
            rootClassName="following-root-class-name5"
          ></Following>
        </div>
      </div>
      <RightSidebar rootClassName="right-sidebar-root-class-name"></RightSidebar>
