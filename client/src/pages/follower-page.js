...
import Nonfollowing from '../components/nonfollowing'
import RightSidebar from '../components/right-sidebar'
import Footer from '../components/footer'
import './follower-page.css'

const FollowerPage = (props) => {
  return (
    <div className="follower-page-container">
      <Helmet>
        <title>FollowerPage - Downright Previous Termite</title>
        <meta
          property="og:title"
          content="FollowerPage - Downright Previous Termite"
        />
      </Helmet>
      <div className="follower-page-container01">
        <img
          alt="image"
          src="/external/wechatimg148-200h.jpg"
          className="follower-page-image"
        />
        <div className="follower-page-sidebar">
          <nav className="follower-page-nav">
            <div className="follower-page-container02">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="follower-page-icon"
              >
              ...
              <Link to="/" className="follower-page-navlink">
                Home
              </Link>
            </div>
            <div className="follower-page-container03">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="follower-page-icon02"
              >
              ...
              <Link to="/search" className="follower-page-navlink1">
                Search
              </Link>
            </div>
            <div className="follower-page-container04"></div>
            <div className="follower-page-container05">
              <svg viewBox="0 0 1024 1024" className="follower-page-icon04">
              ...
              <span className="follower-page-text">Notifications</span>
            </div>
            <div className="follower-page-container06">
              <svg viewBox="0 0 1024 1024" className="follower-page-icon06">
              ...
              <span className="follower-page-text01">Messages</span>
            </div>
            <div className="follower-page-container07">
              <svg
                viewBox="0 0 731.4285714285713 1024"
                className="follower-page-icon08"
              >
              ...
              <Link to="/profile" className="follower-page-navlink2">
                Profile
              </Link>
            </div>
            <div className="follower-page-container08">
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="follower-page-icon10"
              >
              ...
              <span className="follower-page-text02">Settings</span>
            </div>
            <div className="follower-page-container09"></div>
            <button
              type="button"
              className="follower-page-button mybutton button"
            >
              Post
            </button>
          </nav>
          <div className="follower-page-profile">
            <div
              data-thq="thq-dropdown"
              className="follower-page-thq-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="follower-page-dropdown-toggle"
              >
                <img
                  alt="image"
                  src="/external/%C3%A5%C2%BE%C2%AE%C3%A4%C2%BF%C2%A1%C3%A5%C2%9B%C2%BE%C3%A7%C2%89%C2%87_20240323020804-200h.jpg"
                  className="follower-page-image1"
                />
                <div className="follower-page-container10">
                  <span className="follower-page-text03">GroupA1 Student</span>
                  <span className="follower-page-text04">id: 001</span>
                </div>
                <div
                  data-thq="thq-dropdown-arrow"
                  className="follower-page-dropdown-arrow"
                ></div>
              </div>
              <ul
                data-thq="thq-dropdown-list"
                className="follower-page-dropdown-list"
              >
                <li
                  data-thq="thq-dropdown"
                  className="follower-page-dropdown list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="follower-page-dropdown-toggle1"
                  >
                    <span className="follower-page-text05">Logout</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                  className="follower-page-dropdown1 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="follower-page-dropdown-toggle2"
                  >
                    <span className="follower-page-text06">Reset Password</span>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <div className="follower-page-container11">
        <div className="follower-page-container12">
          <Link to="/profile" className="follower-page-navlink3">
            <svg viewBox="0 0 1024 1024" className="follower-page-icon12">
          ...
          <h1 className="follower-page-text07">
            <span className="follower-page-text08">GroupA1 Student</span>
            <br className="follower-page-text09"></br>
            <span className="follower-page-text10">id: 001</span>
            <br></br>
          </h1>
        </div>
        <div className="follower-page-container13">
          <div className="follower-page-container14">
            <button type="button" className="follower-page-button1 button">
              <span>
                <span>Blacklist</span>
                <br></br>
              </span>
          ...
          <div className="follower-page-container15">
            <button type="button" className="follower-page-button2 button">
              Followers
            </button>
          </div>
          <div className="follower-page-container16">
            <Link to="/friendlist" className="follower-page-navlink4 button">
              Following
            </Link>
          </div>
        </div>
        <div className="follower-page-container17">
          <Following
            iD="004"
            name="Love3100"
            intro="CGPA 3.979"
            imageSrc="/97e4cf398c1c453f98f8135b202479d6-200h.jpg"
            rootClassName="following-root-class-name1"
          ></Following>
          <Nonfollowing
            iD="003"
            name="Michael"
            intro="I like the sunshine soooo much!"
            imageSrc="/939c893b87c4ad883673a20256f6e256-200h.jpg"
            rootClassName="nonfollowing-root-class-name"
            selfintroArea="Yo check out my new album now"
          ></Nonfollowing>
          <Nonfollowing
            iD="005"
            name="TeacherHa"
            intro="I love teaching"
            imageSrc="/download%201-200h.jpg"
            rootClassName="nonfollowing-root-class-name1"
          ></Nonfollowing>
          <Following
            iD="006"
            name="3100BigFan"
            intro="I love study"
            imageSrc="/uqaqhuvavt0-200h.jpg"
            rootClassName="following-root-class-name"
          ></Following>
        </div>
      </div>
      <RightSidebar rootClassName="right-sidebar-root-class-name1"></RightSidebar>
