...
const Post11 = (props) => {
  return (
    <div className="post11-container">
      <Helmet>
        <title>Post11 - Downright Previous Termite</title>
        <meta
          property="og:title"
          content="Post11 - Downright Previous Termite"
        />
      </Helmet>
      <div className="post11-container01">
        <div className="post11-container02"></div>
      </div>
      <div className="post11-header">
        ...
        <div className="post11-container04">
          <div data-thq="thq-navbar-nav" className="post11-desktop-menu"></div>
        </div>
        <strong className="post11-text">Post</strong>
      </div>
      <div className="post11-hero">
        <LeftSidebar></LeftSidebar>
        <div className="post11-hero1 heroContainer">
          <div className="post11-container05">
            <div className="post11-container06">
              <div className="post11-container07">
                <img
                  alt="image"
                  src="/download%201-400h.jpg"
              ...
              <div className="post11-container08">
                <div className="post11-container09"></div>
                <div className="post11-container10">
                  <div className="post11-container11"></div>
                  <span className="post11-text01">
                    <span className="post11-text02">Morning CU!</span>
                    <br></br>
                    <span># CUHK</span>
                    <br></br>
                  </span>
              ...
              <div className="post11-container12">
                ...
                <div className="post11-container13">
                  <span>
                    <span>10</span>
                    <br></br>
                  </span>
                ...
                <div className="post11-container14">
                  <span>
                    <span>0</span>
                    <br></br>
                  </span>
                ...
                <div className="post11-container15">
                  <span>0</span>
                </div>
              </div>
            </div>
            <div className="post11-container16"></div>
            <div className="post11-container17">
              <div className="post11-container18">
                <img
                  alt="image"
                  src="/97e4cf398c1c453f98f8135b202479d6-200h.jpg"
                  className="post11-image3"
                />
                <span className="post11-text13">Love3100</span>
                <span className="post11-date-time1">
                  <DateTimePrimitive
                    format="DD/MM/YYYY"
                    date="Fri Mar 22 2024 23:41:41 GMT+0800 (中国标准时间)"
                  ></DateTimePrimitive>
              ...
              <div className="post11-container19">
                ...
                <div className="post11-container20">
                  <svg viewBox="0 0 1024 1024" className="post11-icon08">
                    <path d="M768 342v-86h-512v86h512zM768 470v-86h-512v86h512zM768 598v-86h-512v86h512zM854 86q34 0 59 25t25 59v512q0 34-25 60t-59 26h-598l-170 170v-768q0-34 25-59t59-25h684z"></path>
                  </svg>
                  <div className="post11-container21">
                    <span>0</span>
                  </div>
                  <svg viewBox="0 0 1024 1024" className="post11-icon10">
                  ...
                  <div className="post11-container22">
                    <span>99</span>
                  </div>
                  <svg viewBox="0 0 1024 1024" className="post11-icon12">
                    <path d="M755.188 64c148.382 0 268.812 120.44 268.812 268.832 0 292.21-315.824 382.842-511.978 679.418-207.522-298.424-512.022-377.572-512.022-679.418 0-148.392 120.426-268.832 268.808-268.832 60.354 0 115.99 27.53 160.796 67.834l-77.604 124.166 224 128-128 320 352-384-224-128 61.896-92.846c35.42-21.768 75.21-35.154 117.292-35.154z"></path>
                  </svg>
                  <div className="post11-container23">
                    <span>
                      <span>0</span>
                      <br></br>
                    </span>
            ...
            <div className="post11-container24">
              <div className="post11-container25">
                <img
                  alt="image"
                  src="/uqaqhuvavt0-200h.jpg"
                  className="post11-image4"
                />
                <div className="post11-container26">
                  <div className="post11-container27">
                    <span className="post11-text26">3100BigFan</span>
                  </div>
                </div>
                <span className="post11-date-time2">
                  <DateTimePrimitive
                    format="DD/MM/YYYY"
                    date="Fri Mar 22 2024 23:41:41 GMT+0800 (中国标准时间)"
                  ></DateTimePrimitive>
              ...
              <div className="post11-container28">
                <span className="post11-text27">
                  <span>Hope I can get a good grade at course CSCI3100.</span>
                  <br></br>
                  <span>Love 3100 !</span>
                  <br></br>
                </span>
                <div className="post11-container29">
                  <svg viewBox="0 0 1024 1024" className="post11-icon14">
                    <path d="M768 342v-86h-512v86h512zM768 470v-86h-512v86h512zM768 598v-86h-512v86h512zM854 86q34 0 59 25t25 59v512q0 34-25 60t-59 26h-598l-170 170v-768q0-34 25-59t59-25h684z"></path>
                  </svg>
                  <div className="post11-container30">
                    <span>0</span>
                  </div>
                  <svg viewBox="0 0 1024 1024" className="post11-icon16">
                    <path d="M512 853.333c-8.32 0-16.683-2.432-23.936-7.339-9.6-6.443-235.008-159.147-304.896-229.163-78.123-78.123-87.168-161.152-87.168-216.832 0-126.464 102.869-229.333 229.333-229.333 76.885 0 144.981 38.016 186.667 96.256 41.685-58.24 109.781-96.256 186.667-96.256 126.464 0 229.333 102.869 229.333 229.333 0 55.68-9.045 138.709-87.168 216.832-70.016 70.016-295.381 222.72-304.896 229.163-7.253 4.907-15.616 7.339-23.936 7.339zM325.333 256c-79.403 0-144 64.597-144 144 0 46.635 7.381 101.717 62.165 156.501 51.712 51.712 208.341 161.067 268.501 202.496 60.16-41.429 216.789-150.784 268.501-202.496 54.784-54.784 62.165-109.867 62.165-156.501 0-79.403-64.597-144-144-144s-144 64.597-144 144c0 23.552-19.072 42.667-42.667 42.667s-42.667-19.115-42.667-42.667c0-79.403-64.597-144-144-144z"></path>
                  </svg>
                  <div className="post11-container31">
                    <span>66</span>
                  </div>
                  <svg viewBox="0 0 1024 1024" className="post11-icon18">
                    <path d="M755.188 64c148.382 0 268.812 120.44 268.812 268.832 0 292.21-315.824 382.842-511.978 679.418-207.522-298.424-512.022-377.572-512.022-679.418 0-148.392 120.426-268.832 268.808-268.832 60.354 0 115.99 27.53 160.796 67.834l-77.604 124.166 224 128-128 320 352-384-224-128 61.896-92.846c35.42-21.768 75.21-35.154 117.292-35.154z"></path>
                  </svg>
                  <div className="post11-container32">
                    <span>
                      <span>0</span>
                      <br></br>
                    </span>
            ...
            <div className="post11-container33">
              <div className="post11-container34">
                <img
                  alt="image"
                  src="/939c893b87c4ad883673a20256f6e256-200h.jpg"
                  className="post11-image5"
                />
                <div className="post11-container35">
                  <div className="post11-container36">
                    <span className="post11-text37">Michael</span>
                  </div>
                </div>
                <span className="post11-date-time3">
                  <DateTimePrimitive
                    format="DD/MM/YYYY"
                    date="Fri Mar 22 2024 23:41:41 GMT+0800 (中国标准时间)"
                  ></DateTimePrimitive>
              ...
              <div className="post11-container37">
                <span className="post11-text38">
                  <span>I have millions of coupons !</span>
                  <br></br>
                </span>
                <div className="post11-container38">
                  <svg viewBox="0 0 1024 1024" className="post11-icon20">
                    <path d="M768 342v-86h-512v86h512zM768 470v-86h-512v86h512zM768 598v-86h-512v86h512zM854 86q34 0 59 25t25 59v512q0 34-25 60t-59 26h-598l-170 170v-768q0-34 25-59t59-25h684z"></path>
                  </svg>
                  <div className="post11-container39">
                    <span>0</span>
                  </div>
                  <svg viewBox="0 0 1024 1024" className="post11-icon22">
                    <path d="M512 853.333c-8.32 0-16.683-2.432-23.936-7.339-9.6-6.443-235.008-159.147-304.896-229.163-78.123-78.123-87.168-161.152-87.168-216.832 0-126.464 102.869-229.333 229.333-229.333 76.885 0 144.981 38.016 186.667 96.256 41.685-58.24 109.781-96.256 186.667-96.256 126.464 0 229.333 102.869 229.333 229.333 0 55.68-9.045 138.709-87.168 216.832-70.016 70.016-295.381 222.72-304.896 229.163-7.253 4.907-15.616 7.339-23.936 7.339zM325.333 256c-79.403 0-144 64.597-144 144 0 46.635 7.381 101.717 62.165 156.501 51.712 51.712 208.341 161.067 268.501 202.496 60.16-41.429 216.789-150.784 268.501-202.496 54.784-54.784 62.165-109.867 62.165-156.501 0-79.403-64.597-144-144-144s-144 64.597-144 144c0 23.552-19.072 42.667-42.667 42.667s-42.667-19.115-42.667-42.667c0-79.403-64.597-144-144-144z"></path>
                  </svg>
                  <div className="post11-container40">
                    <span>0</span>
                  </div>
                  <svg viewBox="0 0 1024 1024" className="post11-icon24">
                    <path d="M755.188 64c148.382 0 268.812 120.44 268.812 268.832 0 292.21-315.824 382.842-511.978 679.418-207.522-298.424-512.022-377.572-512.022-679.418 0-148.392 120.426-268.832 268.808-268.832 60.354 0 115.99 27.53 160.796 67.834l-77.604 124.166 224 128-128 320 352-384-224-128 61.896-92.846c35.42-21.768 75.21-35.154 117.292-35.154z"></path>
                  </svg>
                  <div className="post11-container41">
                    <span>
                      <span>0</span>
                      <br></br>
                    </span>
      ...
      <div className="post11-features"></div>
      <div className="post11-pricing"></div>
      <div className="post11-banner"></div>
      <div className="post11-faq">
        <div className="post11-faq-container faqContainer"></div>
      </div>
      <div className="post11-footer">
