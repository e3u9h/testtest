...
const Login = (props) => {
  ...
  return (
    <div className="login-container">
      <Helmet>
        <title>Login - Downright Previous Termite</title>
        <meta
          property="og:title"
          content="Login - Downright Previous Termite"
        />
      </Helmet>
      ...
      <header data-role="Header" className="login-header1">
        ...
        <div data-role="MobileMenu" className="login-mobile-menu">
          <div className="login-nav1">
            <div className="login-container3">
              ...
              />
              <div data-role="CloseMobileMenu" className="login-menu-close">
          ...
          <div>
            <svg viewBox="0 0 950.8571428571428 1024" className="login-icon04">
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="login-icon06">
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="login-icon08">
      ...
      <div className="login-hero">
        <div className="heroContainer login-hero1">
          <h1 className="login-hero-heading heading1">
            Share Your Voice Online
          </h1>
          <div className="login-container4">
            <div className="login-btn-group1">
          ...
          <div className="login-container5">
            <span className="login-hero-sub-heading bodyLarge">
              <span>
                <span>
          ...
          <img
            alt="image"
            src="/external/wechatimg148-400h.jpg"
