...
import './fblacklist1.css'

const Fblacklist1 = (props) => {
  return (
    <div className="fblacklist1-container">
      <Helmet>
        <title>Fblacklist1 - Downright Previous Termite</title>
        <meta
          property="og:title"
          content="Fblacklist1 - Downright Previous Termite"
        />
      </Helmet>
      <div className="fblacklist1-container01">
        <img
          alt="image"
          src="/external/wechatimg148-200h.jpg"
          className="fblacklist1-image"
        />
        <div className="fblacklist1-sidebar">
          <nav className="fblacklist1-nav">
            <div className="fblacklist1-container02">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="fblacklist1-icon"
              >
              ...
              <span className="fblacklist1-text">Home</span>
            </div>
            <div className="fblacklist1-container03">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="fblacklist1-icon02"
              >
              ...
              <span className="fblacklist1-text01">Search</span>
            </div>
            <div className="fblacklist1-container04"></div>
            <div className="fblacklist1-container05">
              <svg viewBox="0 0 1024 1024" className="fblacklist1-icon04">
              ...
              <span className="fblacklist1-text02">Notifications</span>
            </div>
            <div className="fblacklist1-container06">
              <svg viewBox="0 0 1024 1024" className="fblacklist1-icon06">
              ...
              <span className="fblacklist1-text03">Messages</span>
            </div>
            <div className="fblacklist1-container07">
              <svg
                viewBox="0 0 731.4285714285713 1024"
                className="fblacklist1-icon08"
              >
              ...
              <span className="fblacklist1-text04">Profile</span>
            </div>
            <div className="fblacklist1-container08">
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="fblacklist1-icon10"
              >
              ...
              <span className="fblacklist1-text05">Settings</span>
            </div>
            <div className="fblacklist1-container09"></div>
            <button
              type="button"
              className="fblacklist1-button mybutton button"
            >
              Post
            </button>
          </nav>
          <div className="fblacklist1-profile">
            <div
              data-thq="thq-dropdown"
              className="fblacklist1-thq-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="fblacklist1-dropdown-toggle"
              >
                <img
                  alt="image"
                  src="https://play.teleporthq.io/static/svg/default-img.svg"
                  className="fblacklist1-image1"
                />
                <div className="fblacklist1-container10">
                  <span className="fblacklist1-text06">GroupA1 Student</span>
                  <span className="fblacklist1-text07">id: 001</span>
                </div>
                <div
                  data-thq="thq-dropdown-arrow"
                  className="fblacklist1-dropdown-arrow"
                ></div>
              </div>
              <ul
                data-thq="thq-dropdown-list"
                className="fblacklist1-dropdown-list"
              >
                <li
                  data-thq="thq-dropdown"
                  className="fblacklist1-dropdown list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="fblacklist1-dropdown-toggle1"
                  >
                    <span className="fblacklist1-text08">Logout</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                  className="fblacklist1-dropdown1 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="fblacklist1-dropdown-toggle2"
                  >
                    <span className="fblacklist1-text09">Reset Password</span>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <div className="fblacklist1-container11">
        <div className="fblacklist1-container12">
          <Link to="/profile" className="fblacklist1-navlink">
            <svg viewBox="0 0 1024 1024" className="fblacklist1-icon12">
          ...
          <h1 className="fblacklist1-text10">
            <span className="fblacklist1-text11">GroupA1 Student</span>
            <br className="fblacklist1-text12"></br>
            <span className="fblacklist1-text13">id: 001</span>
            <br></br>
          </h1>
        </div>
        <div className="fblacklist1-container13">
          <div className="fblacklist1-container14">
            <button type="button" className="fblacklist1-button1 button">
              <span>
                <span>Blacklist</span>
                <br></br>
              </span>
          ...
          <div className="fblacklist1-container15">
            <Link to="/follower-page" className="fblacklist1-navlink1 button">
              Followers
            </Link>
          </div>
          <div className="fblacklist1-container16">
            <Link to="/friendlist" className="fblacklist1-navlink2 button">
              Following
            </Link>
          </div>
        </div>
        <div className="fblacklist1-container17">
          <BlockedUser
            iD="007"
            name="Bluee"
            imageSrc="/bluelinee-200h.png"
            blockDate="1/1/2024"
            rootClassName="blocked-user-root-class-name8"
          ></BlockedUser>
          <BlockedUser
            iD="008"
            name="I Hate Study"
            imageSrc="/wechatimg150-200w.jpg"
            blockDate="22/3/2024"
            rootClassName="blocked-user-root-class-name9"
          ></BlockedUser>
          <BlockedUser
            iD="009"
            name="SkySky"
            imageSrc="/external/%C3%A5%C2%BE%C2%AE%C3%A4%C2%BF%C2%A1%C3%A5%C2%9B%C2%BE%C3%A7%C2%89%C2%87_20240323020804-200h.jpg"
            blockDate="26/3/2024"
            rootClassName="blocked-user-root-class-name10"
          ></BlockedUser>
          <BlockedUser
            iD="010"
            name="Samuel"
            imageSrc="/unsplash-image-200w.jpeg"
            blockDate="28/3/2024"
            rootClassName="blocked-user-root-class-name11"
          ></BlockedUser>
        </div>
      </div>
      <RightSidebar rootClassName="right-sidebar-root-class-name8"></RightSidebar>
